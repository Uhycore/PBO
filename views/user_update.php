                ...
                <form action="index.php?modul=user&fitur=update" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="username" name="username"
                            ...
                            required
                            value="<?php echo isset($obj_user->username) ? htmlspecialchars($obj_user->username) : ''; ?>"
                    ...
                    <div class="mb-4">
                        ...
                        <select id="role_name" name="role_name"
                            ...
                            <?php foreach ($listRoleName as $ListRoleName) { ?>
                                <option value="<?php echo htmlspecialchars($ListRoleName->role_name); ?>"
                                    <?php echo (isset($obj_user->role_name) && $obj_user->role_name == $ListRoleName->role_name) ? 'selected' : ''; ?>>
